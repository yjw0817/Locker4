<template>
  ...
  >
    ...
    <text
      ...
      text-anchor="middle"
      dominant-baseline="middle"
      :font-size="props.viewMode === 'front' ? fontSize + LOCKER_VISUAL_SCALE : fontSize"
      fill="#ffffff"
      font-weight="600"
      style="user-select: none; pointer-events: none;"
    >
    ...
    <g v-if="props.isManagementPage && props.lockerStatus?.memberName && viewMode === 'front'">
      ...
      <path
        ...
        :d="`
          M 0 ${logicalDimensions.height - 7 * LOCKER_VISUAL_SCALE - 0.5}
          L ${logicalDimensions.width} ${logicalDimensions.height - 7 * LOCKER_VISUAL_SCALE - 0.5}
      ...
      <text
        v-if="props.lockerStatus.startDate && props.lockerStatus.endDate"
        :x="logicalDimensions.width / 2"
        :y="logicalDimensions.height - 3 * LOCKER_VISUAL_SCALE - 0.5"
        text-anchor="middle"
        dominant-baseline="middle"
